...
class AddItemViewController: UITableViewController, UITextFieldDelegate {
    ...
    func textField(_ inputName: UITextField, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool {
        let oldText = inputName.text!
    ...
    @IBAction func done() {
        ...
        delegate?.addItemDone(self, onDone: item)
    }
